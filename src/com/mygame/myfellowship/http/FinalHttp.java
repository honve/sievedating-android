...
public class FinalHttp {
	...
	private MyRequestHeader requestHeader;
...
//                }
    ...
    private void initClientHeader(MyRequestHeader requestHeader) {
		if(!TextUtils.isEmpty(requestHeader.getTel())){
			clientHeaderMap.put("p", requestHeader.getTel());
		}
		if(!TextUtils.isEmpty(requestHeader.getToken())){
			clientHeaderMap.put("token", requestHeader.getToken());
		}
	}
...
//            }
	...
	public void setRequestHeader(MyRequestHeader requestHeader) {
